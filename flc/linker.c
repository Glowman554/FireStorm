...
void add_location(LocationList* list, const char* name, int64_t byte_idx) {
...
LinkLocation* find_symbol(LocationList* symbols, const char* name) {
...
void write_uint64_le(unsigned char* buf, uint64_t value) {
    buf[0] = (value >> 0) & 0xFF;
    buf[1] = (value >> 8) & 0xFF;
    buf[2] = (value >> 16) & 0xFF;
    buf[3] = (value >> 24) & 0xFF;
