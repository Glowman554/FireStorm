// Code generated by the Encore v1.37.2 client generator. DO NOT EDIT.
...
// Client is an API client for the firestorm-tkk2 Encore application.
type Client struct {
...
func Environment(name string) BaseURL {
	return BaseURL(fmt.Sprintf("https://%s-firestorm-tkk2.encr.app", name))
}
...
func New(target BaseURL, options ...Option) (*Client, error) {
	...
	base := &baseClient{
		...
		userAgent:  "firestorm-tkk2-Generated-Go-Client (Encore/v1.37.2)",
	}
	...
	return &Client{
		...
		Frontend:       &frontendClient{base},
		Remote:         &remoteClient{base},
	}, nil
}
...
func WithAuth(auth AuthenticationAuthenticationHandlerParams) Option {
	return func(base *baseClient) error {
		base.authGenerator = func(_ context.Context) (AuthenticationAuthenticationHandlerParams, error) {
			return auth, nil
		}
		return nil
	}
...
func WithAuthFunc(authGenerator func(ctx context.Context) (AuthenticationAuthenticationHandlerParams, error)) Option {
	return func(base *baseClient) error {
...
type AuthenticationAuthenticationHandlerParams struct {
	Token         *HttpCookie `cookie:"token"`
	Authorization string      `header:"Authorization"`
}

type AuthenticationAuthenticationParams struct {
	Username string `json:"username"`
	Password string `encore:"sensitive" json:"password"`
}

type AuthenticationAuthenticationResponse struct {
	Token string `encore:"sensitive" json:"token"`
}
...
type AuthenticationClient interface {
	CreateUser(ctx context.Context, params AuthenticationAuthenticationParams) (AuthenticationAuthenticationResponse, error)
	DeleteUser(ctx context.Context) error
	LoginUser(ctx context.Context, params AuthenticationAuthenticationParams) (AuthenticationAuthenticationResponse, error)
}
...
func (c *authenticationClient) CreateUser(ctx context.Context, params AuthenticationAuthenticationParams) (resp AuthenticationAuthenticationResponse, err error) {
	// Now make the actual call to the API
	_, err = callAPI(ctx, c.base, "POST", "/user/create", nil, params, &resp)
	if err != nil {
		return
	}
...
func (c *authenticationClient) DeleteUser(ctx context.Context) error {
	_, err := callAPI(ctx, c.base, "GET", "/user/delete", nil, nil, nil)
	return err
}

func (c *authenticationClient) LoginUser(ctx context.Context, params AuthenticationAuthenticationParams) (resp AuthenticationAuthenticationResponse, err error) {
	// Now make the actual call to the API
	_, err = callAPI(ctx, c.base, "POST", "/user/login", nil, params, &resp)
	if err != nil {
		return
	}
...
// FrontendClient Provides you access to call public and authenticated APIs on frontend. The concrete implementation is frontendClient.
// It is setup as an interface allowing you to use GoMock to create mock implementations during tests.
type FrontendClient interface {
	Serve(ctx context.Context, endpoint []string, request *http.Request) (*http.Response, error)
}
...
var _ FrontendClient = (*frontendClient)(nil)

func (c *frontendClient) Serve(ctx context.Context, endpoint []string, request *http.Request) (*http.Response, error) {
	...
	path, err := url.Parse(fmt.Sprintf("/frontend/%s", pathEscapeSlice(endpoint)))
	if err != nil {
...
type RemoteDeletePackageVersionProps struct {
	Version string `json:"version" query:"version"`
}

type RemoteGetVersionsResponse struct {
	Versions []string `json:"versions" query:"version"`
}

type RemoteListFilesProps struct {
	Version string `json:"version" query:"version"`
}
...
type RemoteListPackagesProps struct {
	Limit  int `json:"limit" query:"limit"`
	Offset int `json:"offset" query:"offset"`
}

type RemoteListPackagesResponse struct {
	Packages []RemotePackage `json:"packages"`
}

type RemoteLoadFileProps struct {
	Version string `json:"version" query:"version"`
	Name    string `json:"name" query:"name"`
}

type RemoteLoadFileResponse struct {
...
type RemoteUploadFileProps struct {
	Name    string `json:"name"`
	Version string `json:"version"`
	Content string `json:"content"`
}

// RemoteClient Provides you access to call public and authenticated APIs on remote. The concrete implementation is remoteClient.
// It is setup as an interface allowing you to use GoMock to create mock implementations during tests.
type RemoteClient interface {
	CreatePackage(ctx context.Context, name string) error
	DeletePackage(ctx context.Context, name string) error
	DeletePackageVersion(ctx context.Context, name string, params RemoteDeletePackageVersionProps) error
	GetPackage(ctx context.Context, pkgName string) (RemotePackage, error)
	GetVersions(ctx context.Context, pkgName string) (RemoteGetVersionsResponse, error)
	ListFiles(ctx context.Context, pkgName string, params RemoteListFilesProps) (RemoteListFilesResponse, error)
	ListPackages(ctx context.Context, params RemoteListPackagesProps) (RemoteListPackagesResponse, error)
	LoadFile(ctx context.Context, pkgName string, params RemoteLoadFileProps) (RemoteLoadFileResponse, error)
	UploadFile(ctx context.Context, pkgName string, params RemoteUploadFileProps) error
}
...
var _ RemoteClient = (*remoteClient)(nil)

func (c *remoteClient) CreatePackage(ctx context.Context, name string) error {
	_, err := callAPI(ctx, c.base, "GET", fmt.Sprintf("/package/create/%s", url.PathEscape(name)), nil, nil, nil)
	return err
}

func (c *remoteClient) DeletePackage(ctx context.Context, name string) error {
	_, err := callAPI(ctx, c.base, "GET", fmt.Sprintf("/package/delete/full/%s", url.PathEscape(name)), nil, nil, nil)
	return err
}

func (c *remoteClient) DeletePackageVersion(ctx context.Context, name string, params RemoteDeletePackageVersionProps) error {
	// Convert our params into the objects we need for the request
	reqEncoder := &serde{}

	queryString := url.Values{"version": {reqEncoder.FromString(params.Version)}}

	if reqEncoder.LastError != nil {
		return fmt.Errorf("unable to marshal parameters: %w", reqEncoder.LastError)
	}

	_, err := callAPI(ctx, c.base, "GET", fmt.Sprintf("/package/delete/version/%s?%s", url.PathEscape(name), queryString.Encode()), nil, nil, nil)
	return err
}

func (c *remoteClient) GetPackage(ctx context.Context, pkgName string) (resp RemotePackage, err error) {
	// Now make the actual call to the API
	_, err = callAPI(ctx, c.base, "GET", fmt.Sprintf("/package/get/%s", url.PathEscape(pkgName)), nil, nil, &resp)
	if err != nil {
		return
	}
...
func (c *remoteClient) GetVersions(ctx context.Context, pkgName string) (resp RemoteGetVersionsResponse, err error) {
	// Now make the actual call to the API
	_, err = callAPI(ctx, c.base, "GET", fmt.Sprintf("/package/version/list/%s", url.PathEscape(pkgName)), nil, nil, &resp)
	if err != nil {
		return
	}
...
func (c *remoteClient) ListFiles(ctx context.Context, pkgName string, params RemoteListFilesProps) (resp RemoteListFilesResponse, err error) {
	// Convert our params into the objects we need for the request
	reqEncoder := &serde{}
	...
	// Now make the actual call to the API
	_, err = callAPI(ctx, c.base, "GET", fmt.Sprintf("/package/list/%s?%s", url.PathEscape(pkgName), queryString.Encode()), nil, nil, &resp)
	if err != nil {
		return
	}
...
func (c *remoteClient) ListPackages(ctx context.Context, params RemoteListPackagesProps) (resp RemoteListPackagesResponse, err error) {
	// Convert our params into the objects we need for the request
	reqEncoder := &serde{}

	queryString := url.Values{
		"limit":  {reqEncoder.FromInt(params.Limit)},
		"offset": {reqEncoder.FromInt(params.Offset)},
	}
	...
	// Now make the actual call to the API
	_, err = callAPI(ctx, c.base, "GET", fmt.Sprintf("/package/all?%s", queryString.Encode()), nil, nil, &resp)
	if err != nil {
		return
	}
...
func (c *remoteClient) LoadFile(ctx context.Context, pkgName string, params RemoteLoadFileProps) (resp RemoteLoadFileResponse, err error) {
	// Convert our params into the objects we need for the request
	reqEncoder := &serde{}

	queryString := url.Values{
		"name":    {reqEncoder.FromString(params.Name)},
		"version": {reqEncoder.FromString(params.Version)},
	}
	...
	// Now make the actual call to the API
	_, err = callAPI(ctx, c.base, "GET", fmt.Sprintf("/package/load/file/%s?%s", url.PathEscape(pkgName), queryString.Encode()), nil, nil, &resp)
	if err != nil {
		return
	}
...
func (c *remoteClient) UploadFile(ctx context.Context, pkgName string, params RemoteUploadFileProps) error {
	_, err := callAPI(ctx, c.base, "POST", fmt.Sprintf("/file/upload/%s", url.PathEscape(pkgName)), nil, params, nil)
	return err
}
...
type baseClient struct {
	authGenerator func(ctx context.Context) (AuthenticationAuthenticationHandlerParams, error) // The function which will add the authentication data to the requests
