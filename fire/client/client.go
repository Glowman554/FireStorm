...
// Client is an API client for the firestorm-backend-uwti Encore application.
type Client struct {
...
func Environment(name string) BaseURL {
	return BaseURL(fmt.Sprintf("https://%s-firestorm-backend-uwti.encr.app", name))
}
...
func New(target BaseURL, options ...Option) (*Client, error) {
	...
	base := &baseClient{
		...
		userAgent:  "firestorm-backend-uwti-Generated-Go-Client (Encore/v1.43.8)",
	}
...
type AuthenticationChangePasswordUserParams struct {
	NewPassword string `encore:"sensitive" json:"new_password"`
	OldPassword string `encore:"sensitive" json:"old_password"`
}
...
type AuthenticationClient interface {
	ChangePasswordUser(ctx context.Context, params AuthenticationChangePasswordUserParams) error
	...
	RegisterUser(ctx context.Context, params AuthenticationAuthenticationParams) (AuthenticationAuthenticationResponse, error)
}
...
func (c *authenticationClient) ChangePasswordUser(ctx context.Context, params AuthenticationChangePasswordUserParams) error {
	_, err := callAPI(ctx, c.base, "POST", "/user/password/change", nil, params, nil)
	return err
}
...
func (c *authenticationClient) RegisterUser(ctx context.Context, params AuthenticationAuthenticationParams) (resp AuthenticationAuthenticationResponse, err error) {
	// Now make the actual call to the API
	_, err = callAPI(ctx, c.base, "POST", "/user/register", nil, params, &resp)
	if err != nil {
		return
	}
...
type RemoteClient interface {
	CreatePackage(ctx context.Context, pkgName string) error
	DeletePackage(ctx context.Context, pkgName string) error
	DeletePackageVersion(ctx context.Context, pkgName string, versionName string) error
	...
	ListFiles(ctx context.Context, pkgName string, versionName string) (RemoteListFilesResponse, error)
	ListPackages(ctx context.Context, params RemoteListPackagesProps) (RemoteListPackagesResponse, error)
	LoadFile(ctx context.Context, pkgName string, versionName string, file []string) (RemoteLoadFileResponse, error)
	UploadFile(ctx context.Context, pkgName string, versionName string, file []string, params RemoteUploadFileProps) error
}
...
func (c *remoteClient) CreatePackage(ctx context.Context, pkgName string) error {
	_, err := callAPI(ctx, c.base, "GET", fmt.Sprintf("/package/create/%s", url.PathEscape(pkgName)), nil, nil, nil)
	return err
}

func (c *remoteClient) DeletePackage(ctx context.Context, pkgName string) error {
	_, err := callAPI(ctx, c.base, "GET", fmt.Sprintf("/package/delete/full/%s", url.PathEscape(pkgName)), nil, nil, nil)
	return err
}

func (c *remoteClient) DeletePackageVersion(ctx context.Context, pkgName string, versionName string) error {
	_, err := callAPI(ctx, c.base, "GET", fmt.Sprintf("/package/delete/version/%s/%s", url.PathEscape(pkgName), url.PathEscape(versionName)), nil, nil, nil)
	return err
}
...
func (c *remoteClient) ListFiles(ctx context.Context, pkgName string, versionName string) (resp RemoteListFilesResponse, err error) {
	// Now make the actual call to the API
	_, err = callAPI(ctx, c.base, "GET", fmt.Sprintf("/package/list/%s/%s", url.PathEscape(pkgName), url.PathEscape(versionName)), nil, nil, &resp)
	if err != nil {
		return
	}
...
func (c *remoteClient) LoadFile(ctx context.Context, pkgName string, versionName string, file []string) (resp RemoteLoadFileResponse, err error) {
	// Now make the actual call to the API
	_, err = callAPI(ctx, c.base, "GET", fmt.Sprintf("/package/load/file/%s/%s/%s", url.PathEscape(pkgName), url.PathEscape(versionName), pathEscapeSlice(file)), nil, nil, &resp)
	if err != nil {
		return
	}
...
func (c *remoteClient) UploadFile(ctx context.Context, pkgName string, versionName string, file []string, params RemoteUploadFileProps) error {
	_, err := callAPI(ctx, c.base, "POST", fmt.Sprintf("/file/upload/%s/%s/%s", url.PathEscape(pkgName), url.PathEscape(versionName), pathEscapeSlice(file)), nil, params, nil)
	return err
}
