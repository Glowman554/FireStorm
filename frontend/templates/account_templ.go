...
func PasswordChangeField() templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		templ_7745c5c3_Buffer, templ_7745c5c3_IsBuffer := templ_7745c5c3_W.(*bytes.Buffer)
		if !templ_7745c5c3_IsBuffer {
			templ_7745c5c3_Buffer = templ.GetBuffer()
		...
		ctx = templ.ClearChildren(ctx)
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<form hx-post=\"/frontend/authentication/password/change\" hx-ext=\"json-enc\" hx-swap=\"outerHTML\"><table class=\"glow-table\"><tr class=\"glow-tr\"><td class=\"glow-td\"><p>Old password</p></td><td class=\"glow-td\"><input type=\"password\" name=\"old_password\"></td></tr><tr class=\"glow-tr\"><td class=\"glow-td\"><p>New password</p></td><td class=\"glow-td\"><input type=\"password\" name=\"new_password\"></td></tr><tr class=\"glow-tr\"><td class=\"glow-td\" colspan=\"2\"><input type=\"submit\" value=\"Submit\"></td></tr></table></form>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		if !templ_7745c5c3_IsBuffer {
...
func AccountPage(user *authentication.User, r *http.Request) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		if user == nil {
			...
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<div id=\"choice\"><p>Logged in as ")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `frontend/templates/account.templ`, Line: 62, Col: 35}
			}
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var5))
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("</p><button hx-get=\"/frontend/authentication/delete\" hx-swap=\"outerHTML\" hx-target=\"#choice\">Delete account</button> <button hx-get=\"/frontend/authentication/password/change\" hx-swap=\"outerHTML\" hx-target=\"#choice\">Change password</button> ")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			var templ_7745c5c3_Var6 templ.ComponentScript = logout()
...
func AccountDone(text string, token string) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `frontend/templates/account.templ`, Line: 78, Col: 11}
		}
...
func PasswordChanged() templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		templ_7745c5c3_Buffer, templ_7745c5c3_IsBuffer := templ_7745c5c3_W.(*bytes.Buffer)
		if !templ_7745c5c3_IsBuffer {
			templ_7745c5c3_Buffer = templ.GetBuffer()
		...
		ctx = templ.ClearChildren(ctx)
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<div><p>Successfully changed password</p></div>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		if !templ_7745c5c3_IsBuffer {
